						...
						<tbody>
							...
							<c:forEach var="item" items="${cart}" varStatus="status">
								...
								<tr onmouseover="this.style.backgroundColor='#E0E0ff'"
									...
									<td><a
										href="/JavaWebCart/product/cart/item/delete?index=${ status.index }">X</a>
									</td>
									...
									<td><img width="100"
										src="data:image/png;base64,${item.imageBase64}" /></td>
								</tr>
							</c:forEach>
							<!-- 總計 -->
							<tr>
    							...
    							<td align="center">
        							<c:choose>
            							<c:when test="${empty cart}">
                							<button class="pure-button pure-button-primary" disabled>結帳</button>
            							</c:when>
            							<c:otherwise>
                							<a class="pure-button pure-button-primary"
												href="/JavaWebCart/product/cart/submit">結帳</a>
            							</c:otherwise>
        							</c:choose>
    							</td>
							</tr>
