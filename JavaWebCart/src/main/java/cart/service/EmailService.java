//負責發送email驗證信件給使用者。它使用 Gmail的SMTP伺服器來發送郵件。
...
public class EmailService {
	public static void main(String args[]) {
		new EmailService().sendEmail("a0911869582@gmail.com", "http://localhost:8080/JavaWebCart/");
	}
	// Google應用程式密碼
	// 請參考此篇 https://www.yongxin-design.com/Article/10
	// 請自行產生Google應用程式密碼
	String googleAppPassword = "zndi ficq ocxm zvfg";

	// 寄件者的電子郵件地址
	String from = "a0911869582@gmail.com";
